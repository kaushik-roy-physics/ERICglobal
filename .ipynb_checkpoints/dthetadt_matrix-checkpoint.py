...
# Plot the heatmap of omega_matrix
plt.figure(figsize=(10, 10))
plt.imshow(omega_matrix, cmap='viridis', extent=[0, N, 0, N], origin='upper')
plt.colorbar(label='Omega Matrix Values')
plt.title('Omega Matrix Heatmap')
plt.xlabel('Oscillator Index')
plt.ylabel('Oscillator Index')
plt.savefig('dthetadt_matrix.pdf')
plt.show()
