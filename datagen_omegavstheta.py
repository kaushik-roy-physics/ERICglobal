...
L_values = 1.0  # relative strengths
...
data_to_save = {
    ...
    'H_theta_final': H_theta_final.tolist(),
    'H_derivative_final': H_derivative_final.tolist(),
    'omega_satisfying': omega_satisfying.tolist(),
    'theta_satisfying': theta_satisfying.tolist(),
    'all_omega': all_omega.tolist(),
    'all_theta': all_theta.tolist(),
}

output_filename = "omegavstheta_K4L1_t1000.json"
